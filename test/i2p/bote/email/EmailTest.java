...
public class EmailTest {
    ...
    public void setUp() throws Exception {
        identities = new EmailIdentity[3];
        emails = new Email[3];
        ...
        identities[2] = new EmailIdentity("p2Njb7qvettUyfW3-GdMasoi9PIZbszjC-t2y55yFsP-ib4p2wXUlxL2KTofdcQkhOpR24nnZATfol-QQVKS9AOjggfWIkXQcf6dWraE~YIiNyQJ3sa~MixqKixRsSfpsLuFotDPBShvuSwKTIx7~9k0cfbJn98y1HV7VAEz8xhS");
        identities[2].setPublicName("Lieschen Müller");
        emails[2] = new Email();
        emails[2].setSender(new InternetAddress(identities[2].getPublicName() + " <" + identities[2].getKey() + ">"));
    ...
    public void testHeaderRemoval() throws MessagingException, IOException, GeneralSecurityException {
        ...
        packets = emails[2].createEmailPackets(identities[2], null);
